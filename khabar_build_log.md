...
## Status: P0–P4 DONE · Suite live weekly · Taxonomy classifier Gemini-free + scheduled weekly. Batch to commit: taxonomy_backfill.py, taxonomy_backfill.yml (→.github/workflows/), report_lib.py, report_order.py, report_discount.py. Build log updated.
