...
## Status: P0 DONE · P1 DONE · P2 IN PROGRESS (new signal written; awaiting commit → signal-engine run to populate `signal_l2_clear_rate_by_depth`, then render Report 4 against it — no new product table needed, report reads the signal via report_lib).
